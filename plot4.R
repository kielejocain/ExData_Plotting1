...
## we allow the plot window to hold 4 plots in a 2x2 array
par(mfcol = c(2, 2))
...
plot(Voltage ~ as.POSIXct(datetime), pwr_data, type = "l",
     xlab = "datetime")
plot(Global_reactive_power ~ as.POSIXct(datetime), pwr_data, type = "l",
     xlab = "datetime")
